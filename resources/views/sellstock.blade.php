                  ...
                  <div>
                    ...
                    <div class="flex flex-wrap -mx-3 mb-2">
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <div class="relative">
                                <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-state" name="count">
                                    @for($i=1; $i<=$howManystockscanSell;$i++)
                                        <option value="{{$i}}">{{$i}}
                                        </option>
                                    @endfor
                                </select>
                        ...
                        <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-zip" type="number" max="{{$stock->getLatestPrice()/100}}"  step="0.01" placeholder="1" value="{{$stock->getLatestPrice()/100}}" name="price">
                        </div>
                  </div>
